...
class Disposal(db.Model):
    ...
    def __init__(self, email_id, location, date_posted, rent, size, size_max, size_min,
...
class Acquisition(db.Model):
    ...
    def __init__(self, email_id, budget_min, budget_max, areas, size_max, size_min):
        self.areas = areas
...
class AcquisitionAreas(db.Model):
